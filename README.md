...
Rendered Game which is playable once downloaded is available in the [Ball Game Folder](https://github.com/fayizferosh/ball-game/tree/main/). Use "Ball.exe" application to start the game.
